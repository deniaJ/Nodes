...
void ydle::init_timer(){
	...
	Target frequency is 8000 Hz
	
	Prescaler value | Counter Value
	1				| 1999
	8				| 249	 
	64				| 30.25
	256				|
	...
	*/
	...
	TCCR1B |= ((1 << CS11)); // Set Prescaler to 64us | Need 1 bits resolution ?
	TIMSK1 |= (1<<OCIE1A);
	OCR1A   = 249; // Compare register counter to 2 (128us)
